...
#             X(3),
#             X(4),
#             gtsam.Pose2(np.sqrt(2), np.sqrt(2), np.pi/2),
#             ODOMETRY_NOISE
#         )
#     )

#     x3 = gtsam.Pose2(4.10, 0.10, 0.10)
#     delta = gtsam.Pose2(np.sqrt(2), np.sqrt(2), np.pi/2)

#     initial_estimate.insert(X(4), x3.compose(delta))
